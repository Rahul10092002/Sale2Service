                  ...
                  return (
                    ...
                    >
                      {(() => {
                        ...
                        return (
                          <>
                            {/* ── Compact Mobile Card (Modern Touch-First Design) ── */}
                            <div
                            ...
                            >
                              ...
                              <div className="pl-1.5">
                                ...
                                <div className="flex items-baseline justify-between gap-2">
                                  <p
                                    className="font-bold text-xs text-ink-base dark:text-slate-100 truncate hover:text-blue-600 dark:hover:text-blue-400"
                                    onClick={(e) => {
                                ...
                                {/* Items Single-Line Summary */}
                                {invoice.invoice_items?.length > 0 && (
                                  <div className="flex items-center gap-1.5 mt-1 text-[11px] text-slate-600 dark:text-slate-300">
                                    <span className="shrink-0 px-1.5 py-0.2 rounded bg-slate-100 dark:bg-slate-800 text-[10px] font-semibold text-slate-500 dark:text-slate-400">
                                      {invoice.invoice_items.length}{" "}
                                      {invoice.invoice_items.length === 1 ? "item" : "items"}
                                    </span>
                                ...
                                <div className="flex items-center justify-between gap-2 mt-1.5 pt-1.5 border-t border-gray-100 dark:border-dark-border/40">
                                  <div className="flex items-center gap-1.5 flex-wrap">
                                    <span
                                      className={`text-[9.5px] px-2 py-0.5 rounded-full font-semibold tracking-wide ${getPaymentStatusColor(
                                    ...
                                    {isOverdue && (
                                      <span className="text-[9.5px] px-1.5 py-0.5 rounded-full bg-red-100 text-red-700 dark:bg-red-950/60 dark:text-red-400 font-semibold flex items-center gap-1">
                                    ...
                                    {invoice.payment_mode && (
                                      <span className="text-[9.5px] px-1.5 py-0.5 rounded bg-gray-100 dark:bg-slate-800 text-gray-600 dark:text-slate-300 uppercase font-medium">
                                        {invoice.payment_mode.replace("_", " ")}
                                      </span>
                                    )}
                                  </div>
