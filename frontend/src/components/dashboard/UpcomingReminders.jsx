        ...
        {allReminders.map((reminder, index) => {
          ...
          return (
            <div
              ...
              className="flex items-start gap-3 p-4 rounded-lg border border-gray-200 hover:border-gray-300 hover:shadow-sm transition-all"
            >
      ...
      <div className="mt-4 pt-4 border-t border-gray-200">
        <div className="grid grid-cols-2 gap-4 text-center">
          <div>
            ...
            <p className="text-xs text-gray-500 mt-1">Service Reminders</p>
          </div>
          <div>
            <p className="text-2xl font-bold text-purple-600">
              {warrantyReminders.length}
            </p>
            <p className="text-xs text-gray-500 mt-1">Warranty Reminders</p>
          </div>
        </div>
      </div>
    </div>
