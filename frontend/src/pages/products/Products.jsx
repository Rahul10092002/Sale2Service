                ...
                {products.map((product, index) => {
                  ...
                  >
                    ...
                    {(() => {
                      ...
                      const isExpiringSoon = w?.isExpiringSoon;
                      ...
                      return (
                        ...
                        >
                          ...
                          <div className="pl-1.5">
                            ...
                            {/* Customer & Invoice single line preview */}
                            {product.customer && (
                              <div className="flex items-center gap-1.5 mt-1 text-[11px] text-slate-600 dark:text-slate-400 truncate">
                                <span
                                  className="font-medium text-blue-600 dark:text-blue-400 hover:underline shrink-0"
                                  onClick={(e) => {
                                ...
                                {product.invoice && (
                                  <>
                                    <span>·</span>
                                    <span
                                      className="font-mono text-indigo-600 dark:text-indigo-400 hover:underline shrink-0"
                                      onClick={(e) => {
                            ...
                            <div className="flex items-center justify-between gap-2 mt-1.5 pt-1.5 border-t border-gray-100 dark:border-dark-border/40">
                              <div className="flex items-center gap-1.5 flex-wrap">
                                {w ? (
                                  ...
                                  >
                                    {w.isExpired ? "Warranty Expired" : `${w.diffDays}d warranty`}
                                  </span>
                                ) : (
                                  <span className="text-[9.5px] px-2 py-0.5 rounded-full font-medium bg-gray-100 dark:bg-slate-800 text-gray-500">
                                    No Warranty
                                  </span>
                                )}
